To run the notebook, first update the first cell of the notebook with the path to the datasets folder. (path_to_the_data_folder = '/kaggle/input/' change this to the current dataset folder.)
